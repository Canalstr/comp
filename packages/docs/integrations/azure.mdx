...
description: 'Connect Azure to Passt for cloud security testing'
---

# Azure Integration

The Azure integration enables you to connect your Microsoft Azure cloud environment to Passt for comprehensive security testing, compliance monitoring, and risk assessment using Microsoft Defender for Cloud
...
Passt requires read-only access to your Azure environment. The integration uses Azure's built-in Reader role or custom roles with specific permissions that follow the principle of least privilege.
