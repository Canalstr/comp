...
description: 'Connect Google Cloud Platform to Passt for cloud security testing'
---

# Google Cloud Platform Integration

The Google Cloud Platform (GCP) integration allows you to connect your GCP projects to Passt for automated compliance monitoring, and risk assessment.
...
1. Navigate to **Settings > Integrations** in your Passt dashboard
...
3. Link Service Account
   ...
   - Paste it into the **Service Account Key** field in the Passt connection form
...
Passt requires read-only access to your GCP environment. The integration uses a service account with specific IAM roles that follow the principle of least privilege.
